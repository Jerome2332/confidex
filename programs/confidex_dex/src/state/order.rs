...
impl ConfidentialOrder {
    ...
    // =========================================================================
    // =========================================================================
    // DEPRECATED PLAINTEXT HELPERS - DO NOT USE IN NEW CODE
    // =========================================================================
    //
    // These methods are DEPRECATED and will be removed in the next major version.
    // They read/write plaintext values from encrypted fields, which breaks privacy.
    //
    // PRODUCTION CODE SHOULD USE:
    // - `settle_order_callback` with MPC-decrypted values for settlement
    // - `cancel_order_callback` with MPC-calculated refund for cancellation
    // - MPC circuits for any operations requiring encrypted values
    //
    // These remain temporarily for:
    // - Legacy settle_order fallback (use settle_order_callback instead)
    // - cancel_order until Phase 3.3 MPC refund is implemented
    // =========================================================================

    /// DEPRECATED: Get order amount as plaintext u64
    ///
    /// # Security Warning
    /// This method reads plaintext from encrypted fields, breaking privacy.
    /// Use MPC-based operations instead.
    #[deprecated(
        since = "2.0.0",
        note = "Use MPC-based operations. This breaks privacy by reading plaintext."
    )]
    ...
    /// DEPRECATED: Set order amount plaintext
    ///
    /// # Security Warning
    /// This method writes plaintext to encrypted fields, breaking privacy.
    #[deprecated(
        since = "2.0.0",
        note = "Use encrypted order placement. This breaks privacy by storing plaintext."
    )]
    pub fn set_amount_plaintext(&mut self, amount: u64) {
        self.encrypted_amount[0..8].copy_from_slice(&amount.to_le_bytes());
    }

    /// DEPRECATED: Get order price as plaintext u64
    ///
    /// # Security Warning
    /// This method reads plaintext from encrypted fields, breaking privacy.
    /// Use MPC-based settlement via `settle_order_callback` instead.
    #[deprecated(
        since = "2.0.0",
        note = "Use settle_order_callback with MPC-decrypted values."
    )]
    ...
    /// DEPRECATED: Set order price plaintext
    ///
    /// # Security Warning
    /// This method writes plaintext to encrypted fields, breaking privacy.
    #[deprecated(
    ...
    /// DEPRECATED: Get filled amount as plaintext u64
    ///
    /// # Security Warning
    /// This method reads plaintext from encrypted fields, breaking privacy.
    /// Use MPC-based settlement via `settle_order_callback` instead.
    ...
    /// DEPRECATED: Set filled amount plaintext
    ///
    /// # Security Warning
    /// This method writes plaintext to encrypted fields, breaking privacy.
    #[deprecated(
        since = "2.0.0",
        note = "Use MPC fill calculation. This breaks privacy by storing plaintext."
    )]
    pub fn set_filled_plaintext(&mut self, amount: u64) {
        self.encrypted_filled[0..8].copy_from_slice(&amount.to_le_bytes());
    }

    /// DEPRECATED: Check if order has been filled
    ///
    /// # Security Warning
    /// This uses deprecated plaintext methods.
    #[deprecated(
        since = "2.0.0",
        note = "Check encrypted_filled[0] != 0 instead (MPC sets this flag)."
    )]
    #[allow(deprecated)]
    ...
    /// DEPRECATED: Get remaining unfilled amount
    ///
    /// # Security Warning
    /// This uses deprecated plaintext methods. Use MPC for remaining calculation.
    #[deprecated(
        since = "2.0.0",
        note = "Use MPC-based refund calculation for remaining amounts."
    )]
    #[allow(deprecated)]
